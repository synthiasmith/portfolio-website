          ...
          <div className="grid gap-12 md:grid-cols-12 md:items-center">
            ...
            <div className="space-y-8 md:col-span-7">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-2.5 text-sm text-accent-foreground font-semibold transition-transform hover:scale-105 active:scale-[0.98] shadow-sm"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-card-border bg-card px-6 py-2.5 text-sm font-semibold transition-transform hover:scale-105 active:scale-[0.98] shadow-sm"
                >
          ...
          <div className="border-t border-card-border/40 pt-12 max-w-4xl mx-auto">
            <div className="grid gap-12 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <a
                  href="mailto:synthia@themitragroup.com"
                  className="flex w-full items-center justify-center gap-3 rounded-full bg-accent px-6 py-2.5 text-sm text-accent-foreground font-semibold transition-transform hover:scale-105 active:scale-[0.98] shadow-sm"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex w-full items-center justify-center gap-3 rounded-full border border-card-border bg-card px-6 py-2.5 text-sm font-semibold transition-transform hover:scale-105 active:scale-[0.98] shadow-sm"
                >
                  <LinkedinLogo size={18} />
                  Connect on LinkedIn
                </a>
